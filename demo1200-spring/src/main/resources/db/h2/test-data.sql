...
insert into singer(first_name, last_name, birth_date) values('John', 'Bulter', '1975-04-01');
...
insert into album(singer_id, title, release_date) values(2, 'From The Gradle', '1994-09-13');
